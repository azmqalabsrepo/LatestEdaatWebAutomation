...
public class ClientPayablesInstallmentsBillsPage extends BasePage {
	...
	public void VerifyInstallmentgridView(Log Log)
	{
		try
		{
			...
			{
			test.log(Status.PASS,"#FUNC-Installment Bill Grid View" + driver.getTitle() +" * Installment Bill Grid View PASS * ");
		 	Log.ReportEvent("PASS", "  Verify Grid view details is successfull");
			}
			else
			{
			test.log(Status.FAIL,"#FUNC-Installment Bill Grid View" + driver.getTitle() +" * Installment Bill Grid View FAIL * ");	
			}

		}
		catch (Exception e) {			
			test.log(Status.FATAL,"#FUNC-Installment Bill Grid View" + driver.getTitle() +" * Installment Bill Grid View FAIL * ");	
		}
	}
}
