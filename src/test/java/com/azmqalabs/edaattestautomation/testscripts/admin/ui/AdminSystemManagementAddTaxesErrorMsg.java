	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Taxes Management is Page dispayed Suceessfull");
	        	Pages.AdminSystemMangement.navigateSystemMangementTax(Log);
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Taxes Management Add Tax Error Message is Suceessfull"); 
	         	Pages.AdminSystemMangement.AddTaxErrorMsg(testdatamap);
