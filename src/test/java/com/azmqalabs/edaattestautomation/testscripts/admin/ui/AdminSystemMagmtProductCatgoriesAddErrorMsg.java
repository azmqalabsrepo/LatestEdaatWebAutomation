...
public void myTest() throws InterruptedException, Exception{
    try{
    	...
    	Log.ReportEvent("INFO", "Step4 : Verify Product Management Add Category Error Message is Suceessful");
    	Pages.AdminSystemMangement.AddCategoryErrorMsg(testdatamap);
